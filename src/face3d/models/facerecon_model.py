...
class FaceReconModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=False):
        ...
        parser.add_argument('--init_path', type=str, default='/content/SoundSketch_vidoe_lipSync/checkpoints/init_model/resnet50-0676ba61.pth')
        parser.add_argument('--use_last_fc', type=util.str2bool, nargs='?', const=True, default=False, help='zero initialize the last fc')
        parser.add_argument('--bfm_folder', type=str, default='/content/SoundSketch_vidoe_lipSync/checkpoints/BFM_Fitting/')
        ...
        if is_train:
            ...
            parser.add_argument('--net_recog_path', type=str, default='/content/SoundSketch_vidoe_lipSync/checkpoints/recog_model/ms1mv3_arcface_r50_fp16/backbone.pth')
